...
<style type="text/css">
  ...
  .banner .main_image li a{display:block;width:100%;}
    ...
    div.flicking_con a{position:relative; width:10px;height:9px;background:url('../addons/ewei_shop/template/mobile/default/static/images/dot.png') 0 0 no-repeat;display:inline-block;text-indent:-8730px; text-indent:-1000px}
