...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="./themes/style63/style/vweisiteV01.css"/>
    <link href="./themes/style63/style/index36.css" media="screen" rel="stylesheet" type="text/css" />
	<script src="./themes/style63/script/vweisiteV01.js" type="text/javascript"></script>
	...
	<script type="text/javascript" src="<?php  echo $_W['siteroot'];?>/resource/script/bootstrap.js"></script>
	<script type="text/javascript" src="<?php  echo $_W['siteroot'];?>/resource/script/cascade.js"></script>
