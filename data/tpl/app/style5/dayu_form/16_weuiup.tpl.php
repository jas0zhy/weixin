...
.upload{opacity: 0;position: relative;z-index: 10;width:100%;height:2rem;margin:0;padding:0;}
.file img{height:80px;}
</style>
        ...
        <div class="weui_cell">
            <div class="weui_cell_bd weui_cell_primary">
                <div class="weui_uploader">
                    ...
                    <div class="weui_uploader_bd file">
							<?php  echo tpl_form_field_image('field_' . $fields['refid'] . '_' . $fields['bind'], '');?>
					</div>
				</div>
            </div>
        </div>
