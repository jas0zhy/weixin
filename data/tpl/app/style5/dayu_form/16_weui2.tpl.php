	...
	<?php  if($activity['isinfo']) { ?>
		<div class="weui_cells weui_cells_access" style="margin:0;">
			<a class="weui_cell" href="http://api.map.baidu.com/marker?location=<?php  echo $activity['loc_x'];?>,<?php  echo $activity['loc_y'];?>&title=<?php  echo urlencode($activity['business']);?>&content=<?php  echo urlencode($activity[address].' activity'.$store['tel']);?>&output=html">
				<div class="weui_cell_bd weui_cell_primary f14">地址：<?php  echo $activity['address'];?></div>
				<div class="weui_cell_ft"></div>
			</a>
			<a class="weui_cell" href="tel:<?php  echo $activity['tel'];?>">
				<div class="weui_cell_bd weui_cell_primary f14">电话：<?php  echo $activity['tel'];?></div>
				<div class="weui_cell_ft"></div>
			</a>
		</div>
	<?php  } ?>
...
$(function(){
	$(".weui_textarea").on("input paste" , function(){
		...
		<div class="weui_cells_title"><?php  echo $fields['title'];?><?php  if($fields['essential']) { ?><span class="f-red">*</span><?php  } ?></div>
		<div class="weui_cells weui_cells_radio">
			<?php  $i=1;?>
			<?php  if(is_array($fields['options'])) { foreach($fields['options'] as $v) { ?>
			<label class="weui_cell weui_check_label" for="r<?php  echo $fields['refid'];?><?php  echo $i;?>">
				<div class="weui_cell_bd weui_cell_primary"><p><?php  echo $v;?></p></div>
				<div class="weui_cell_ft">
					<input type="radio" class="weui_check" name="field_<?php  echo $fields['refid'];?>_<?php  echo $fields['bind'];?>" id="r<?php  echo $fields['refid'];?><?php  echo $i;?>" value="<?php  echo $v;?>" <?php  if($i==1) { ?>checked="checked"<?php  } ?>>
		...
		<div class="weui_cells weui_cells_checkbox">
			<?php  $i=1;?>
			<?php  if(is_array($fields['options'])) { foreach($fields['options'] as $v) { ?>
			<label class="weui_cell weui_check_label" for="c<?php  echo $fields['refid'];?><?php  echo $i;?>">
				<div class="weui_cell_hd">
					<input type="checkbox" class="weui_check" name="field_<?php  echo $fields['refid'];?>_<?php  echo $fields['bind'];?>[]" id="c<?php  echo $fields['refid'];?><?php  echo $i;?>" value="<?php  echo $v;?>">
		...
		<div class="weui_cell weui_cell_select weui_select_after">
			<div class="weui_cell_hd"><?php  echo $fields['title'];?><?php  if($fields['essential']) { ?><span>*</span><?php  } ?></div>
			<div class="weui_cell_bd weui_cell_primary">
				<select class="weui_select" name="field_<?php  echo $fields['refid'];?>_<?php  echo $fields['bind'];?>">
				<?php  if(is_array($fields['options'])) { foreach($fields['options'] as $v) { ?>
            ...
            <div class="weui_cell_bd weui_cell_primary">
                <div class="weui_uploader">
                    <div class="weui_uploader_hd weui_cell">
                        <div class="weui_cell_bd weui_cell_primary"><?php  echo $fields['title'];?><?php  if($fields['essential']) { ?><span class="f-red">*</span><?php  } ?></div>
                        <div class="weui_cell_ft"></div>
                    </div>
                    <div class="weui_uploader_bd">
                        <ul class="weui_uploader_files">   
                            <input type="hidden" name="field_<?php  echo $fields['refid'];?>_<?php  echo $fields['bind'];?>" accept="image/*" capture="camera" value="" />
                            <image class="weui_uploader_file weui_uploader_status" id="show<?php  echo $fields['refid'];?>" src="<?php  echo tomedia($fields['image'])?>" />
                        </ul>
                        <div class="weui_uploader_input_wrp" id="<?php  echo $fields['refid'];?>">
                        </div>
                    </div>
                </div>
            </div>
...
<script>
	...
	$("#<?php  echo $fields['refid'];?>").cityPicker({
		...
		<?php  } ?>
				...
				<?php  } } ?>
	<?php  if($activity['plural']==1) { ?>
        <div class="weui_cell">
            <div class="weui_cell_bd weui_cell_primary">
                <div class="weui_uploader">
                    <div class="weui_uploader_hd weui_cell">
                        <div class="weui_cell_bd weui_cell_primary"><?php  echo $activity['pluraltit'];?></div>
...
<script type="text/javascript">
	$('#form').submit(function(){
       ...
       var mobile = /^(((13[0-9]{1})|(14[7-9]{1})|(15[0-9]{1})|(17[0-9]{1})|(18[0-9]{1}))+\d{8})$/;
		...
		<?php  if(in_array($fields['type'], array('text', 'calendar', 'email'))) { ?>
		...
		<?php  } ?>
		<?php  if(in_array($fields['type'], array('checkbox'))) { ?>		
		if($(':checkbox[name="field_<?php  echo $fields['refid'];?>_<?php  echo $fields['bind'];?>[]"]:checked').length == 0) {
			$.toast("<?php  echo $fields['title'];?> 必须选择", "cancel");
			return false;
		}
		<?php  } ?>
