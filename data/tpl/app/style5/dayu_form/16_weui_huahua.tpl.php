...
<?php  } ?>
<style>
body{background-color:#fbf9ff;background-image:url(<?php  echo $activity['thumb'];?>);
...
<div class="weui_cells weui_cells_access">
	...
	<div class="weui_cell">
		<div class="weui_cell_hd"><label class="weui_label"><?php  echo $fields['title'];?><?php  if($fields['essential']) { ?><span>*</span><?php  } ?></label></div>
		<div class="weui_cell_bd weui_cell_primary">
			<input class="weui_input" type="tel" name="field_<?php  echo $fields['refid'];?>_<?php  echo $fields['bind'];?>" value="<?php  echo $fields['default'];?>" pattern="[0-9]*" placeholder="<?php  echo $fields['tixing'];?>">
		</div>
	</div>
		<?php  } ?>
            ...
            <div class="weui_cell_bd weui_cell_primary">
                <div class="weui_uploader">
                    <div class="weui_uploader_hd weui_cell">
                        <div class="weui_cell_bd weui_cell_primary"><?php  echo $fields['title'];?><?php  if($fields['essential']) { ?><span>*</span><?php  } ?></div>
                        <div class="weui_cell_ft"></div>
                    </div>
