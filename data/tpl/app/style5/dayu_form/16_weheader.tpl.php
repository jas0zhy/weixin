...
<head>
	...
	<link rel="stylesheet" href="<?php echo MODULE_URL;?>template/weui/style/weui.css"/>
	<link rel="stylesheet" href="<?php echo MODULE_URL;?>template/weui/style/weui.min.css">
    <script type="text/javascript" src="http://res.wx.qq.com/open/js/jweixin-1.0.0.js"></script>
	<script src="<?php echo MODULE_URL;?>template/weui/js/jquery-2.1.4.js"></script>
	<script src="<?php echo MODULE_URL;?>template/weui/js/jquery-weui.min.js"></script>
...
<body id="message" <?php  if($activity['isloc']==1) { ?>onload="init()" <?php  } ?>ontouchstart>
<div class="weui_tab">
