...
<style>
	...
	.box{width:100%; margin:2px auto; padding:0 1%;}
	.box .box-item{float:left; display:inline-block; width:40%; margin:1%;margin-left:6.5%;  text-align:center; text-decoration:none; outline:none; height:40px; padding:0 10px; overflow:hidden; line-height:40px; color:#FFF; background:rgba(75, 38, 11, 0.1);}
	.box .box-item span{color:<?php  echo $_W['styles']['fontnavcolor'];?>; display:block; width:100%; height:40px; line-height:40px; font-size:17px; font-weight: bold; overflow:hidden;}
</style>
