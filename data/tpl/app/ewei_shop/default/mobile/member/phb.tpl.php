...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/addons/ewei_shop/static/css/jfpx/integral.css">
...
<section style="background:#ff9900;margin-top:-17px;">
	<img src="/addons/ewei_shop/static/images/integral.jpg" border="0" width="100%">
</section>
<div class="list-myorder" style="background:#ffffff;">
	<ul class="ul-product" style="color:#ffcc00;font-size:20px;">
		...
		<?php  if(is_array($list)) { foreach($list as $member) { ?>
            ...
            <span style="float:right;margin-left:10px;border-radius:3px;"><img style="width:30px;height:42px;" src="/addons/ewei_shop/static/images/0<?php  echo $key;?>.jpg" style="border-width:0px;"></span>
            <?php  } ?>
				<span class="pic" onClick="newMsg('<?php  echo $member["openid"];?>');"><img src="<?php  echo tomedia($member['avatar']);?>" onerror="this.src='/addons/ewei_shop/static/images/notoo.png'" style="border-radius:50px;"></span>
				<div class="text">
