...
<style type="text/css">
    ...
    .header .user .user-head {height:48px; width:48px; background:#fff; border-radius:50%; float:left;}
    ...
    .header .user-gold .take {height:30px; width:auto; padding:0 10px; line-height:30px; font-size:16px; float:right; background:#ff6600; border-radius:5px; margin-top:2px; color:#fff;}
    .header .user-op .take1 {height:30px; width:auto; padding:0 10px; line-height:30px; font-size:16px; float:right;margin-left:10px; background:#00cc00; border-radius:5px; margin-top:2px; color:#fff;}
    ...
    .order_pub span {height:16px; width:16px; background:#f30; border-radius:8px; position:absolute; top:0; right:10px; font-size:12px; color:#fff; line-height:16px;}
    .order_1 {width:24%;}
    .order_2 {width:25%;}
    .order_3 {width:25%;}
    .order_4 {width:25%;}
...
<script id="member_center" type="text/html">
    <div class="header">
        <div class="user">
            ...
            <div class="user-info">
                ...
                <div class="user-other" <?php  if(!empty($set['levelurl'])) { ?>onclick='location.href="<?php  echo $set['levelurl'];?>"'<?php  } ?>>[<%level.levelname%>] <?php  if(!empty($set['levelurl'])) { ?><i class='fa fa-question-circle' ></i><?php  } ?>
                </div>
            </div>
    ...
    <div class="user-gold">
        ...
        <div class="num">￥<%member.credit2%></div>
        <div style="width:1px; height:15px; float:left; background:#ccc; margin:10px"></div>
        <div class="title">积分：</div>
        <div class="num"><%member.credit1%></div>
