...
<title>全部商品</title>
<style type="text/css">
    body {margin:0px; width:100%; height:100%; background:#eee; color:#fff; font-family:sans-serif;-webkit-appearance: none;-webkit-overflow-scrolling : touch;}
    html {}
   ...
   .main .category .all p.category_item { padding-top:10px;}
    .main .category .all p.child {height:auto; width:100%; font-size:16px; line-height:20px;  padding-left:15px;padding-top:10px;}
    ...
    .main .page .topbar {height:28px; width:100%; background:#d12147; padding:8px 0;position:fixed;}
    .main .page .topbar .list1 {height:28px; width:10%; float:left; margin-left:3%; line-height:28px; font-size:18px; text-align:left; color:#fff;}
    .main .page .topbar .name {height:28px; width:54%; padding-left:10%; margin:auto; text-align:center; float:left; font-size:16px; line-height:28px; color:#fff;}
    .main .page .topbar .sort {height:28px; width:10%; float:right; font-size:18px; line-height:28px; padding-top:5px; text-align:right; color:#fff;}
    .main .page .topbar .search {height:28px; width:10%; float:right; margin-right:3%; font-size:18px; line-height:25px; text-align:right; color:#fff;}

    .main .page .goods {height:auto; width:98%; padding:0 1%; margin-top:5px; float:left;}
    .main .page .goods .good {height:auto;  width:46%; background:#fff; padding:1%; margin:5px 1%; float:left;}
    ...
    .main .page .sort_list {height:100px; width:90px; background:rgba(51,51,51,0.8); border-radius:5px; position:absolute; top:50px; right:5%; display:none;}
    .main .page .sort_list .nav {height:25px; width:90px; line-height:25px; font-size:12px; color:#fff; text-align:center;}
    .main .page .sort_list .navon {color:#d12147;}
...
<script id='tpl_main' type='text/html'>
    ...
    <div class="main">
        ...
        <div class='page'>
            ...
            <!--topbar-->
            <div class="topbar">
                <div class="list1"><i class="fa fa-list-ul"></i></div>
