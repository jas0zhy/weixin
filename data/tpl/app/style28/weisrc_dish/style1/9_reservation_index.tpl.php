...
<div ng-view="" style="height: 100%;" class="ng-scope">
    ...
    <div class="section ng-scope" style="margin-top: 45px;margin-bottom: 0px;">
    ...
    <div class="main-view ng-scope" id="time-points-index" style="padding-top: 1px;">
        ...
        <div class="table-zone-item">
            ...
            <div class="time-points">
                ...
                <span class="button time-point ng-binding ng-scope <?php  if($cur_date == $select_date) { ?><?php  if($cur_time < $row['time']) { ?>border-red<?php  } ?><?php  } else { ?>border-red<?php  } ?>" <?php  if($cur_date == $select_date) { ?><?php  if($cur_time < $row['time']) { ?>onclick="selectTime(<?php  echo $row['id'];?>);"<?php  } ?><?php  } else { ?>onclick="selectTime(<?php  echo $row['id'];?>);"<?php  } ?>><?php  echo $row['time'];?></span>
                <?php  } ?>
                <?php  } } ?>
            </div>
