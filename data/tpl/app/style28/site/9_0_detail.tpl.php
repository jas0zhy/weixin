...
legend{color:#000;}
body{color:#222;background:#EBEBEB;font-family:Helvetica, STHeiti STXihei, Microsoft JhengHei, Microsoft YaHei, Tohoma, Arial;height:100%;position:relative;}
...
#mbutton > span{float:right; display:inline-block; background:#F96567; border:1px #DDD solid; color:#FFF; height:30px; line-height:30px; padding:0 10px; margin-left:10px;}
#mcover{position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0, 0, 0, 0.7);display:none;z-index:20000;}
#mcover img{position:fixed;right: 18px;top:5px;width:260px;height:180px;z-index:20001;}
.head{height:40px; line-height:40px; background:#F96567; padding:0 5px; color:#FFF;}
...
.head .order{background:#f79c9d; position:absolute; z-index:9999; right:0;}
...
.head .order li.fa-caret-up{font-size:20px;color:#f79c9d;position:absolute;top:-11px;right:16px;}
</style>
<div class="head">
