...
<head>
	...
	<meta name="description" content="微信公众平台自助引擎，微擎" />
    
	<link type="text/css" rel="stylesheet" href="<?php  echo $_W['siteroot'];?>/resource/style/bootstrap.css">
	<link type="text/css" rel="stylesheet" href="<?php  echo $_W['siteroot'];?>resource/style/font-awesome.min.css" />   
     <!-- CSS files start -->
            <link href="./themes/style62/css/framework.css" rel="stylesheet" type="text/css" media="all" />
            <link href="./themes/style62/css/colorbox.css" rel="stylesheet" type="text/css" media="all" />
            <link href="./themes/style62/css/elements.css" rel="stylesheet" type="text/css" media="all" />
            <link href="./themes/style62/css/style.css" rel="stylesheet" type="text/css" media="all" />
            <link href="./themes/style62/css/responsive.css" rel="stylesheet" type="text/css" media="screen" />
            <link href="./themes/style62/css/hidpi.css" rel="stylesheet" type="text/css" media="screen" />
            <link href="./themes/style62/css/skin.css" rel="stylesheet" type="text/css" media="all" />
            <link href="./themes/style62/css/custom.css" rel="stylesheet" type="text/css" media="all" />
        <!-- CSS files end -->
        
        <!-- JavaScript files start -->
			<script type="text/javascript" src="./themes/style62/js/jquery.min.js"></script>
            <script type="text/javascript" src="./themes/style62/js/effects.jquery-ui.min.js"></script>
            <script type="text/javascript" src="./themes/style62/js/jquery.nivo-slider.min.js"></script>
            <script type="text/javascript" src="./themes/style62/js/jquery.colorbox.min.js"></script>
            <script type="text/javascript" src="./themes/style62/js/custom.js"></script>
        <!-- JavaScript files end -->
        
<style>
	/*个人中心*/
	.banner{background:url('themes/default/images/bg_home.jpg');background-size:cover;height:150px;width:100%;position:relative;}
	...
	#footer{padding:0; width:100%; height:40px; line-height:40px; text-align:center; color:#666; position:relative; float:left; bottom: auto; font-size:12px;}
