<?php defined('IN_IA') or exit('Access Denied');?>	<?php  if(empty($footer_off)) { ?><div id="footer">&copy;<?php  if(empty($_W['account']['name'])) { ?>微擎<?php  } else { ?><?php  echo $_W['account']['name'];?><?php  } ?></div><?php  } ?>
</div>
<?php  if(!empty($quick)) { ?>
