...
legend{color:#000;}
body{color:#222;background:#ecf7fc;font-family:Helvetica, STHeiti STXihei, Microsoft JhengHei, Microsoft YaHei, Tohoma, Arial;height:100%;position:relative;}
...
.head{height:40px; line-height:40px; background:#2384B5; padding:0 5px; color:#FFF;}
...
.head .order{background:#31a8e4; position:absolute; z-index:9999; right:0;}
...
.head .order li.fa-caret-up{font-size:20px;color:#31a8e4;position:absolute;top:-11px;right:16px;}
</style>
<div class="head">
