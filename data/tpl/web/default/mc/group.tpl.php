			...
			<div class="form-group">
				...
				<div class="col-sm-9 col-xs-12">
					<label class="radio-inline">
						<input type="radio" name="grouplevel" value="1" <?php  if($setting['grouplevel'] == 1 || !$setting['grouplevel']) { ?>checked<?php  } ?>/>根据总积分多少自动升降
					</label>
					<label class="radio-inline">
						<input type="radio" name="grouplevel" value="2" <?php  if($setting['grouplevel'] == 2) { ?>checked<?php  } ?>/>根据总积分多少只升不降
					</label>
