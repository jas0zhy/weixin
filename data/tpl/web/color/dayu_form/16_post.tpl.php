...
<ul class="breadcrumb">
	...
	<?php  } ?>
	<?php  if($reid) { ?><li class="active">编辑表单</li><?php  } ?>
...
<div class="main">
	...
	<form class="form-horizontal form" action="" method="post" enctype="multipart/form-data" onsubmit="return validate(this);">
		...
		<div class="tab-pane" id="tab_field"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('post_field', TEMPLATE_INCLUDEPATH)) : (include template('post_field', TEMPLATE_INCLUDEPATH));?></div>
		<div class="tab-pane" id="tab_setting"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('post_setting', TEMPLATE_INCLUDEPATH)) : (include template('post_setting', TEMPLATE_INCLUDEPATH));?></div>
		<div class="tab-pane" id="tab_body"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('post_notice', TEMPLATE_INCLUDEPATH)) : (include template('post_notice', TEMPLATE_INCLUDEPATH));?></div>
		<div class="tab-pane" id="tab_get"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('post_get', TEMPLATE_INCLUDEPATH)) : (include template('post_get', TEMPLATE_INCLUDEPATH));?></div>
		</div>
