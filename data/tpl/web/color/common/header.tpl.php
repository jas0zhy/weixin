    ...
    <header id="header-navbar" class="content-mini content-mini-full">
        ...
        <li class="dropdown topbar-notice">
                    <a type="button"  data-toggle="dropdown" style="padding-left:15px">
                        <span class="badge badge-primary" ><i class="fa fa-bell"></i> <span id="notice-total">0</span> </span>                    </a>
        ...
        <ul class="nav-header pull-left">
            ...
            <li class="hidden-xs hidden-sm">
                ...
                <?php  if(!empty($_W['isfounder']) || empty($_W['setting']['permurls']['sections']) || in_array('extt', $_W['setting']['permurls']['sections'])) { ?><li<?php  if(FRAME == 'ext') { ?> class="active"<?php  } ?> id="liebiaoyuan"><a href="<?php  echo url('home&a=welcome&do=ext&m=ewei_shop');?>"><i class="fa fa-cubes"></i>人人商城管理</a></li><?php  } ?>                <?php  if(!empty($_W['isfounder']) || empty($_W['setting']['permurls']['sections']) || in_array('extt', $_W['setting']['permurls']['sections'])) { ?><li<?php  if(FRAME == 'ext') { ?> class="active"<?php  } ?> id="liebiaoyuan"><a href="<?php  echo url('site&a=entry&op=display&do=order&m=ewei_shop');?>"><i class="fa fa-cubes"></i>订单查询</a></li><?php  } ?>               

				<?php  if(FRAME == 'solution') { ?><li class="active" id="liebiaoyuan"><a href="<?php  echo url('home/welcome/solution', array('m' => $m));?>"><i class="fa fa-comments"></i>行业功能 - <?php  echo $solution['title'];?></a></li><?php  } ?>
                <?php  if(IMS_FAMILY != 'x') { ?>
                <?php  } ?>                                                           
        </ul>
