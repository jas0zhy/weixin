		...
		<div class="panel-body">
			<div class="clearfix">
				...
				<div class="col-sm-5 text-right">
					<img <?php  if(file_exists(IA_ROOT . '/attachment/qrcode_'.$account['acid'].'.jpg')) { ?> src="<?php  echo $_W['attachurl_local'];?>qrcode_<?php  echo $account['acid'];?>.jpg?acid=<?php  echo $account['acid'];?>"<?php  } else { ?>src="resource/images/gw-wx.gif"<?php  } ?> class="img-avatar img-avatar48"  />
					<img <?php  if(file_exists(IA_ROOT . '/attachment/headimg_'.$account['acid'].'.jpg')) { ?> src="<?php  echo $_W['attachurl_local'];?>headimg_<?php  echo $account['acid'];?>.jpg?acid=<?php  echo $account['acid'];?>"<?php  } else { ?>src="resource/images/gw-wx.gif"<?php  } ?> class="img-avatar img-avatar48"  />
				</div>
			</div>
		</div>
	</div>
