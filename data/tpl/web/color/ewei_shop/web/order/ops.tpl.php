                                        ...
                                        <?php  if($item['isverify']==1) { ?>
                                            <!--核销 确认核销-->
                                             <?php if(cv('order.op.verify')) { ?>
                                                 <a class="btn btn-primary btn-sm" href="<?php  echo $this->createWebUrl('order', array('op' => 'deal','to'=>'confirmsend1','id' => $item['id']))?>" onclick="return confirm('确认使用吗？');return false;">确认使用</a>
                                             <?php  } ?>
                                        <?php  } else { ?>
                                            <!--自提 确认取货-->
