		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div>
						<div class="input-group">
							...
							<input type="number" name="width" class="form-control" value="<?php  if(!empty($item['width'])) { ?><?php  echo $item['width'];?><?php  } else { ?>860<?php  } ?>" onchange="pagesize()" />
							<div class="input-group-addon" style="border-right:none; border-left: none;">pt(磅) 单据高度</div>
							<input type="number" name="height" class="form-control" value="<?php  if(!empty($item['height'])) { ?><?php  echo $item['height'];?><?php  } else { ?>460<?php  } ?>" onchange="pagesize()" />
							<div class="input-group-addon" style="border-right:none; border-left: none;">pt(磅)</div>
			...
			<div class="panel" style="height: auto; overflow: hidden; background: none;">
				...
				<div class="edit-right">
					<div id="container" style="width:<?php  if(!empty($item['width'])) { ?><?php  echo $item['width'];?><?php  } else { ?>860<?php  } ?>pt; height: <?php  if(!empty($item['height'])) { ?><?php  echo $item['height'];?><?php  } else { ?>460<?php  } ?>pt;">
	...
	<script language='javascript'>
		function pagesize(){
				var _width = $("input[name=width]").val();
			 	...
			 	$("#container").height(_height+"pt").width(_width+"pt");
		}
		function delInput(){
		...
		function previews() {
			...
			LODOP.PRINT_INITA(0,0,Width,Height,"快递单预览"); //5238
